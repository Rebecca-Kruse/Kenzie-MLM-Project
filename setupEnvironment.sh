...
export UNIT_FIVE_REPO_NAME=ata-unit-five-project-Rebecca-Kruse
export GITHUB_USERNAME=rebecca-kruse
export GITHUB_TOKEN='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'
